...
export const config = {
  light: vars({
      '--color-primary-0': '210 240 210',
      '--color-primary-50': '190 230 190',
      '--color-primary-100': '170 220 170',
      '--color-primary-200': '150 210 150',
      '--color-primary-300': '130 200 130',
      '--color-primary-400': '110 190 110',
      '--color-primary-500': '90  180 90',
      '--color-primary-600': '75  150 75',
      '--color-primary-700': '60  120 60',
      '--color-primary-800': '45  90  45',
      '--color-primary-900': '30  60  30',
      '--color-primary-950': '15  30  15',
