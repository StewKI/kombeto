...
export default class ApiService {
  ...
  //public static readonly BASE_URL = `https://${this.HOSTNAME}/kombeto/`;


  private static readonly HOSTNAME: string = "10.168.132.136";
  public static readonly BASE_URL = `http://${this.HOSTNAME}/`;
